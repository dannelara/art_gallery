        ...
        <Section padding>
            <div className='h-full w-full flex flex-col xmd:flex-row gap-4'>
                <div className='flex flex-col gap-3 xmd:gap-5 xmd:flex-1'>
                    ...
                    <div className='py-4 max-h-[22.313rem] aspect-square flex items-center justify-center xmd:hidden tilt relative'>
                ...
                <div className='hidden xmd:flex flex-1 items-center justify-center md:scale-no-border'>
                    <div className='py-2 w-full md:w-[30rem] aspect-square rounded-xl overflow-hidden tilt'>
