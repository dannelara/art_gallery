        ...
        <Section padding>
            <div className='flex flex-col w-full'>
                ...
                <div className='mt-10 grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 my-10 w-full'>
                    <ArtCard id={8} title='Eden' creator={{ img: "/images/new/13.png", name: "Rahiros" }} img='/images/new/12.png' details={{
                        createdAt: new Date(new Date().setFullYear(new Date().getFullYear() - 10)),
                        monthlyUpload: 50,
                    }} />
                    <ArtCard id={5} title='--' creator={{ img: "/images/new/11.jpg", name: "Salomon" }} img='/images/new/7.png' details={{
                        createdAt: new Date(new Date().setFullYear(new Date().getFullYear() - 5)),
                        monthlyUpload: 32,
                    }} />
                    <ArtCard id={11} title='Gazer_1' creator={{ img: "/images/new/11.jpg", name: "Salomon" }} img='/images/new/11.jpg' details={{
                        createdAt: new Date(),
                        monthlyUpload: 21,
                    }} />
                </div>
